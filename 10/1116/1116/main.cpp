...
/**
 ...
 並設計一class為PokemonHealthCenter 為class Pokemon 的 friend class
 使其可以直接存取Pokemon 的私有成員，
 建立建構式可以設定PokemonHealthCenter的名字
 有一方法(函式)void Cure(Pokemon &p)可幫助Pokemon直接回血並印出xxx has restored health at yyy. xxx為神奇寶貝的名字，yyy為神奇寶貝中心的名稱
